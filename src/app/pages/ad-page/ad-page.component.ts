...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, MainHeadComponent, HeaderComponent, BreadcrumbComponent, MainImgComponent, MiniImgComponent, AdDicriptionComponent,NgFor,GalleryComponent],
